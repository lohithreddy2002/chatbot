...
def initialize_index(llm_name, model_temperature, table_context_dict, api_key, sql_path="sqlite:////home/lohith/chatbot/test.db"):
...
table_context_dict = {
    "entries": DEFAULT_BUSINESS_TABLE_DESCRP, 
    "vehicles": DEFAULT_VIOLATIONS_TABLE_DESCRP
}



llama_index = initialize_index(llm_name, model_temperature, table_context_dict if use_table_descrp else None, api_key)
